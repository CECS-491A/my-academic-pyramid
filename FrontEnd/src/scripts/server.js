...
(function ($, window, undefined) {
    ...
    $.hubConnection.prototype.createHubProxies = function () {
        ...
        proxies['MessengerHub'].server = {
            ...
            /// <summary>Calls the Send method on the server-side MessengerHub hub.&#10;Returns a jQuery.Deferred() promise.</summary>
            /// <param name=\"message\" type=\"String\">Server side type is System.String</param>
                return proxies['MessengerHub'].invoke.apply(proxies['MessengerHub'], $.merge(["Send"], $.makeArray(arguments)));
             }
        };
