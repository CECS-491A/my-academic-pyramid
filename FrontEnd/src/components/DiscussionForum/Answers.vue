          ...
          <!-- <template v-for="(item, index) in questions"> -->
            ...
            >
              <v-list-tile-content>
                ...
                <v-list-tile-sub-title>{{ "Helpful Count: " + item.HelpfulCount + " Unhelpful Count: " + item.UnHelpfulCount + " Spam Count " + item.SpamCount 
                    + " Is Correct Answer: " + item.IsCorrectAnswer}}</v-list-tile-sub-title>
              </v-list-tile-content>
